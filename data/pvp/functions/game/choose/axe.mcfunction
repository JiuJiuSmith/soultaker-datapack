...
=======
item replace entity @s container.0 with minecraft:iron_axe{CustomModelData: 13, Unbreakable: 1}
item replace entity @s container.1 with carrot_on_a_stick{CustomModelData: 21, cage: 1, display: {Name: '[{"text":"灵魂容器","color":"aqua","italic": false}]'}}

item replace entity @s armor.head with minecraft:chainmail_helmet{Unbreakable: 1}
item replace entity @s armor.chest with minecraft:chainmail_chestplate{Unbreakable: 1, AttributeModifiers: [{AttributeName: "generic.armor", Operation: 0, Amount: 4, Slot: "chest", Name: "Armor", UUID: [I; 1, 2, 3, 4]}]}
item replace entity @s armor.legs with minecraft:chainmail_leggings{Unbreakable: 1, AttributeModifiers: [{AttributeName: "generic.armor", Operation: 0, Amount: 3, Slot: "legs", Name: "Armor", UUID: [I; 5, 6, 7, 8]}]}
