...
item replace entity @s armor.head with minecraft:leather_helmet{Unbreakable: 1, Damage: 0, display: {color: 3223857}}
item replace entity @s armor.chest with minecraft:leather_chestplate{Unbreakable: 1, Damage: 0, display: {color: 3223857}}
item replace entity @s armor.legs with minecraft:leather_leggings{Unbreakable: 1, Damage: 0, display: {color: 3223857}}
item replace entity @s armor.feet with minecraft:leather_boots{Unbreakable: 1, Damage: 0, display: {color: 3223857}}
>>>>>>> origin
