...
scoreboard players operation @s inherit_soul *= #3 operation
scoreboard players operation @s inherit_soul /= #10 operation
scoreboard players set #operation operation 100
scoreboard players operation #operation operation -= @s inherit_soul
