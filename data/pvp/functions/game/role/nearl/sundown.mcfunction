...
# 替换“光”为耀阳
item replace entity @s weapon.mainhand with carrot_on_a_stick{CustomModelData:17, blazing_sun:0, display:{Name:'[{"text":"耀阳", "color":"gold", "bold": true, "italic": false}]'}, AttributeModifiers:[{AttributeName:"generic.attack_damage", Operation:0, Amount:4, Slot:"mainhand", Name:"Armor", UUID:[I;2376,8811,7442,3900]},{AttributeName:"generic.attack_speed",Operation:0,Amount:-2.4,Slot:"mainhand",Name:"Armor",UUID:[I;2231,1732,9123,4204]}]}
