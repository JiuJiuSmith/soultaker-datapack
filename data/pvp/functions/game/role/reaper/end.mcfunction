...
item replace entity @s[nbt={Inventory: [{id: "minecraft:iron_axe", Slot: -106b, tag: {CustomModelData: 14, Unbreakable: 1b}}]}] weapon.mainhand with minecraft:iron_axe{CustomModelData: 13, Unbreakable: 1}
