...
item replace entity @s armor.chest with minecraft:leather_chestplate{Unbreakable:1b,Damage:0,AttributeModifiers:[{AttributeName:"generic.armor",Operation:0,Amount:4,Slot:"chest",Name:"Armor",UUID:[I;25,26,27,28]},{AttributeName:"generic.movement_speed",Operation:0,Amount:-0.01,Slot:"mainhand",Name:"Armor",UUID:[I;21,22,23,24]}],display:{color:15233282}}
