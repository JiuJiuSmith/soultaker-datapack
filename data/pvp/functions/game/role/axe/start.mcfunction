...
execute if score @s soul matches ..2 run replaceitem entity @s weapon.mainhand minecraft:iron_axe{CustomModelData:13,Unbreakable:1}
...
execute if score @s soul matches 1.. run replaceitem entity @s weapon.mainhand minecraft:iron_axe{CustomModelData:14,Unbreakable:1}
